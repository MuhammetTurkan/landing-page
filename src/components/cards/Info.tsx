...
const Info = ({ title, description, children }: InfoProps) => {
  return (
    <div
      className="p-5 sm:p-6 lg:p-6 rounded-3xl border border-box-border bg-box-bg shadow-lg
    ...
    >
      ...
      <h2 className="text-heading-2 w-max relative font-semibold lg:text-xl">
        {title}
      </h2>
