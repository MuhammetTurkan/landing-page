    ...
    <section className="relative pt-32 lg:pt-36">
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0">
          ...
          ></span>
          <span className="absolute right-4 bottom-12 w24 h-24 rounded-3xl bg-primary blur-xl opacity-80 "></span>
        </div>
        <div
        ...
        >
          ...
          <Paragraph className="mt-8">
            ...
            workflows to deliver realtime insights, intelligent automation, and
          ...
          <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
            <div className="flex sm:flex-row flex-col gap-5 w-full ">
              ...
              >
                <span className="min-w-max pr-2 border-r border-box-border flex items-center justify-center">
