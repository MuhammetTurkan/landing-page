    ...
    <section id="about-us">
      <Container className="flex flex-col md:flex-row gap-10 lg:gap-12 items-center">
        ...
        <div className="w-full md:w-7/12 lg:w-1/2 flex flex-col">
          ...
          <Paragraph>
            We are on a mission the empower businesses with transformative AI
            ...
            uniqe needs. Join us and lead the digital revolution in your
            industry.
          </Paragraph>

          <div className="pt-8 grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl">
            <Info
              title="Mission"
